...
选择子的结构如下：
  ...
  ![](https://ghproxy.net/https://raw.githubusercontent.com/CuB3y0nd/IMAGES/master/assets/Untitled-2024-03-31-132221.svg)
...
而下图就是 GDT 表项的结构了，其中灰色的那位是 `L (Long Mode)` 位，用于指示是 32-bit 还是 64-bit.
  ...
  ![](https://upload.wikimedia.org/wikipedia/commons/0/0a/SegmentDescriptor.svg)
