...
我原本打算从经典的 GLIBC 2.23 入手，后来一读代码发现这个版本包含的内容有点太少了，故问了下 Civiled，得到了新路线：
  ...
  ![](https://v6.gh-proxy.org/https://github.com/CuB3y0nd/picx-images-hosting/raw/master/.esuth1g0w.avif)
  ![](https://v6.gh-proxy.org/https://github.com/CuB3y0nd/picx-images-hosting/raw/master/.lw2owmf84.avif)
...
- 开启 ASLR 时，**start_brk** 以及 **brk** 也会指向同一位置，只是这个位置是在 data / bss 段结尾后的随机偏移处
  ...
  ![](https://v6.gh-proxy.org/https://github.com/CuB3y0nd/picx-images-hosting/raw/master/.3k8ctqpino.avif)
